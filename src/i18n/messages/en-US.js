...
export default {
	[LOCALES.ENGLISH]: {
		...
		"HOME_MAIN_TEXT_9": "Young Author Debut Award {cash}",
		...
		"terms_1": "Rules of PHODAR Biennial 12th Series Awards Competition",
		"terms_2": "The present Rules describe the Terms and Conditions for entering the 12th international PHODAR Biennial Series Award Competition (hereinafter PHODAR Biennial).",
		...
		"terms_4": "The topic of the 12th edition of the PHODAR Biennial Award Competition is „Sameness and semblance”. The themes around which the editions of the festival are united aim to direct the attention of the participants to various aspects of the current socio-political and cultural issues both on a global, regional and individual level. The present topic refers both to the biblical account of the creation of the world, and to the dramaturgy of the great Bulgarian writer Yordan Radichkov, who with his eponymous work in the style of absurdism subjects the clamor for more power to those in power to devastating criticism.",
		...
		"terms_14": "For the Entry, you can submit between 8 and 24 images with coherent overall look – photo essay, from an unfinished, ongoing or completed project. The photographs have to be created after 2021 when was the last edition of the PHODAR Biennial. No stock photography is allowed.",
		...
		"terms_23": "Brief FAQ:",
		"terms_24": "{question} Each author can participate with only one collection.",
